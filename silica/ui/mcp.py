...
INSTRUCTIONS = (
    ...
    "source file; grep is for an exact string or a symbol name. A concept goes in "
    "query and its identifiers in queries, one call. silica_search "
    ...
    "narrow it. The dense leg runs by itself when the server has section "
    ...
    "Read a passage with silica_read before citing it and carry the "
